...
//   const rooms = useSelector((state) => state.rooms); // adjust 'rooms' to your slice name
...
//   //   { name: "Room 1", shape: "circle" },
//   //   { name: "Room 2", shape: "square" },
//   //   { name: "Room 3", shape: "hex" },
//   // ]);

//   return (
//     <div className="w-[340px] rounded-[12px] bg-white p-[16px] border border-gray-200 text-sm font-medium shadow-sm">
//       {/* Header */}
...
//           <div
//             key={index}
//             className="flex items-center border border-gray-300 rounded-[8px] px-[10px] py-[6px] bg-gray-200 text-gray-500"
//           >
//             <span className="text-gray-500 text-[13px]">{room.name}</span>
//           </div>
//         ))}
//       </div>
//     </div>
...
const AreaMarkupSidebar = () => {
  ...
  return (
    <div className="w-[340px] h-full rounded-[12px] bg-white p-[16px] border border-gray-200 text-sm font-medium shadow-sm relative">
      {/* Header */}
      <div className="flex justify-between items-start">
        <div>
          <h2 className="text-[#222222] font-semibold text-[14px] leading-[18px]">
